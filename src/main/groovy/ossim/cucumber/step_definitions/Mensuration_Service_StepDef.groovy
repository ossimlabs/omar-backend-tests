...
When(~/^the mensuration service is called with two points on (.*) (.*) (.*) (.*) image$/) {
...
When(~/^the mensuration service is called with four points on (.*) (.*) (.*) (.*) image$/) {
    String index, String platform, String sensor, String format ->
...
When(~/^the mensuration service is called with a polygon of nine points on (.*) (.*) (.*) (.*) image$/) {
    String index, String platform, String sensor, String format ->
